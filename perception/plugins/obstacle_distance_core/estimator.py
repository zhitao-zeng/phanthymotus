...
class ObstacleDistanceEstimator:
    ...
    def _indoor_distance(self, prediction) -> float:
        ...
        return self._apply_distance_calibration(distance, config)
    ...
    def estimate(
        ...
        try:
            ...
            direct_indoor = (
                domain is SceneDomain.INDOOR
                and is_valid_indoor_distance_backend(self._depth_backend)
            )
            if direct_indoor:
            ...
            if domain is SceneDomain.INDOOR and not direct_indoor:
